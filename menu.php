            ...
            <div class="PanelDerecho">
                ...
                <div class="CuerpoLogin">
                    ...
                    <form class="FormularioLogin" action="login.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="password">
                            <input type="password" class="inputLogin" name="contrasena" id="password_usuario"
                                placeholder="**********">
        ...
        <div class="popup-content">
            ...
            <div class="PanelDerecho">
                ...
                <div class="CuerpoSign">
                    ...
                    <form class="FormularioRegistro" action="insertar_datos_registro.php" method="POST"
                        ...
                        <div class="formularioRegistroFlex">
                            ...
                            <div class="columnaSegundaFormularioRegistro">
                                <input type="tel" class="inputLogin" name="telefono_usuario" id="telefono_usuario"
                                    placeholder="Teléfono">
                                <input type="text" class="inputLogin" name="username" id="username"
                                    placeholder="Nombre de usuario">
                                <div class="password">
                                    <input type="password" class="inputLogin" name="contrasena" id="passwordRegistro"
                                        placeholder="**********">
                                    <img src="./img/ojo_cerrado.png" onclick="togglePasswordRegistro()"
                                        class="pass-icon-registro" id="pass-icon-registro">
                                </div>
                            </div>
                        </div>
                        <div class="boton">
